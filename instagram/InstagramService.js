...
var InstagramService = /** @class */ (function () {
    ...
    InstagramService.prototype.initialize = function (bot) {
        ...
        bot.registerCommand('gomazbomb', function (msg, args) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fetchData('croatiart')];
                    case 1:
                        timelineMedia = (_a.sent()).graphql.user.edge_owner_to_timeline_media;
                        msg.channel.send(timelineMedia.edges[Utils_1.random(0, timelineMedia.edges.length - 1)].node.display_url);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    InstagramService.prototype.fetchData = function (profile) {
